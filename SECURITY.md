...
local input and write local artifacts. A campaign executes EasyBuild recipes on
a configured local or SSH target, optionally through Slurm, Podman, or Docker.
