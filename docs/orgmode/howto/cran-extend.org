...
A leftover CRAN package emits a ~Bundle~ with ~exts_defaultclass =
'RPackage'~. Already-provided extras collapse to ~R-bundle-CRAN~. The
leftover itself is the ~exts_list~ entry. ~plan_cran_emits_a_single_r_package~
pins that shape.
