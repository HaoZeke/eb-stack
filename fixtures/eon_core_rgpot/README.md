...
- `r/rgpot/rgpot-2.5.3-GCCcore-15.2.0.eb` — fat build: RPC server (`potserv`), Eigen backend, nanobind Python bindings, RocksDB potential cache, unit + example tests (#26480 fat-build review)
- `n/nanobind/nanobind-2.13.0-GCCcore-15.2.0.eb` — Python binding companion for fat rgpot (first easyconfig; none upstream)
- `r/RocksDB/RocksDB-10.10.1-GCCcore-15.2.0.eb` — potential-cache companion for fat rgpot (first easyconfig; none upstream)
