...
pub fn classify_build_failure(
    ...
    let source_failure = text.contains("failed to download")
        ...
        || text.contains("unable to fetch")
        || text.contains("couldn't fetch")
...
";
    ...
    fn download_timeout_is_a_source_failure() {
        ...
        assert_eq!(
            classify_build_failure(
                "build",
                "failed to download foo.tar.gz: EAFNOSUPPORT",
                "",
                None
            ),
            BuildFindingClass::Source
        ...
        assert_eq!(
            classify_build_failure(
                "build",
                "failed to download foo.tar.gz: EOPNOTSUPP",
                "",
                None
            ),
            BuildFindingClass::Source
        ...
        assert_eq!(
            classify_build_failure("build", "failed to download foo.tar.gz: ENOTSUP", "", None),
            BuildFindingClass::Source
        );
        assert_eq!(
            classify_build_failure(
        ...
        assert_eq!(
            classify_build_failure(
                "build",
                "failed to download foo.tar.gz: ENOPROTOOPT",
                "",
                None
            ),
            BuildFindingClass::Source
        ...
        assert_eq!(
            classify_build_failure("build", "unable to fetch foo.tar.gz", "", None),
            BuildFindingClass::Source
        );
        assert_eq!(
            classify_build_failure("build", "couldn't fetch foo.tar.gz", "", None),
            BuildFindingClass::Source
        );
        assert_eq!(
            classify_build_failure("build", "failed to retrieve foo.tar.gz", "", None),
            BuildFindingClass::Source
        );
        assert_eq!(
            classify_build_failure("build", "could not retrieve foo.tar.gz", "", None),
            BuildFindingClass::Source
        );
        assert_eq!(
